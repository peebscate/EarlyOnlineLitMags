...
One question I wrestled with while working with the data sample was "What is a useful way to visualize all of this?" Since it is an incomplete sample (and a complete sample is likely impossible), can it say anything? After experimenting with various graph and chart possibilities, I created the following graph using Datawrapper. This chart gives a visually coherent overview of publication lifespan and accessibility. 

<div style="min-height:750px" id="datawrapper-vis-3FCBl"><script type="text/javascript" defer src="https://datawrapper.dwcdn.net/3FCBl/embed.js" charset="utf-8" data-target="#datawrapper-vis-3FCBl"></script><noscript><img src="https://datawrapper.dwcdn.net/3FCBl/full.png" alt="" /></noscript></div>
